...
export default class extends Phaser.State {
	create () {
		...
		window.game.global.tutorialAudio = window.game.add.audio('tutorial', 1, false);
		window.game.global.basedSoulAudio = window.game.add.audio('basedSoul', 1, false);
		...
		// dow.game.global.jumpAudio = window.game.add.audio('jump', 0.3, false);
